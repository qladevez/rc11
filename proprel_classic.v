...
Proof.
  ...
  - constructor.
    ...
    + intros n m x a b. split. intros [c <- H]; auto. intros H. exists a; simpl; firstorder.
    + right. intros n m x a b. split. intros [c H <-]; auto. intros H. exists b; simpl; firstorder.
